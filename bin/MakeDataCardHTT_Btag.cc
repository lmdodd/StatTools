#include "UWAnalysis/StatTools/interface/DataCardCreatorHTT_Btag.h"
...
int main (int argc, char* argv[]) 
{
    ...
    DataCardCreatorHTT_Btag creator(parser);
    ...
    if(bitmask[0]==1){
        ...
        creator.makeHiggsShape(inclSel,catSel,"_inclusive","EffCSVWeight0");
    ...
    if(bitmask[1]==1){
        ...
        creator.makeHiggsShape(inclSel,catSel,"_0j","EffCSVWeight0");
    ...
    if(bitmask[2]==1){
        ...
        creator.makeHiggsShape(inclSel,catSel,"_1j","EffCSVWeight0");
    ...
    if(bitmask[2]==2){
        ...
        creator.makeHiggsShape(inclSel,catSel,"_1jboost","EffCSVWeight0");
    ...
    if(bitmask[3]==1){
        ...
        std::string catSelH = parser.stringValue("vbfselectionHiggs"); 
        std::string bTagSF = parser.stringValue("bTagSF");					 

        creator.makeHiggsShape(inclSel,catSelH,"_vbf","EffCSVWeight0");
